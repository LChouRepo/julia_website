...
export default async function Sidebar() {
  ...
  //   <>
  //     {/* ================= MOBILE ================= */}
  //     <header className="lg:hidden sticky top-0 z-[70] bg-black/55 backdrop-blur border-b border-white/10">
  ...
  //     {/* ================= DESKTOP ================= */}
  //     <aside className="hidden lg:flex fixed inset-y-0 left-0 z-[60] w-64 flex-col bg-black/55 backdrop-blur border-r border-white/10 p-6 text-white">
